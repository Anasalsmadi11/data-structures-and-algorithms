...
const sortByChildren = (charArray) => {
  ...
  charArray.sort((a, b) => {
    ...
    // If the number of children is the same, compare the house name alphabetically
...
const containsW = (str) => {
  // Solution code here...
  const pattern = /w/; //  match the letter 'w' in lower case
...
const isNum = (input) => {
  // Solution code here...
  const pattern = /\d/; // Regular expression pattern to match any digit
...
const containsWorld = (input) => {
  // Solution code here...
  const pattern = /\bworld\b/; // to match the word 'world' as a whole
  return pattern.test(input);
};
...
const isCapitalized = (str) => {
  // Solution code here...
  const pattern = /\b[A-Z][A-Za-z]*\b/g; //  to match capitalized words
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  const pattern = /^[A-J]/i; // Regular expression pattern to match cities starting with letters A to J (case-insensitive)
